...
$jsonFilePath = "C:\samples\Stage1-PreReqScript\insights.JSON"
$jsonContent = Get-Content -Path $jsonFilePath | ConvertFrom-Json

# Modify the workspaceResourceId value with the provided subscription ID
$jsonContent.properties.destinations.logAnalytics.workspaceResourceId = "/subscriptions/$WorkspaceSubscriptionId/resourceGroups/AZM-SNow/providers/Microsoft.OperationalInsights/workspaces/LAW-AZM-SNOW-INSIGHTS"
