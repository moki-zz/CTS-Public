...
# Define variables
$alertRuleNamePrefix = "Key Vault - Overall vault saturation - azm "
...
foreach ($KeyVault in $KeyVaults)
{
    ...
    $condition = New-AzMetricAlertRuleV2Criteria -MetricName "SaturationShoebox" -TimeAggregation "average" -Operator "GreaterThan" -Threshold 50
