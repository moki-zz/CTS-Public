...
# Define variables
$alertRuleNamePrefix = "Storage Account - Table - tableCapacity - azm "
...
foreach ($storageAccount in $storageAccounts) {
    ...
    $condition = New-AzMetricAlertRuleV2Criteria -MetricName "TableCapacity" -TimeAggregation "Average" -Operator "GreaterThan" -Threshold 10737418240
